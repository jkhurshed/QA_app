...
class Answer(models.Model):
    ...
    question_text = models.ForeignKey("answers_app.Question", on_delete=models.CASCADE, 
    ...
    video_answer = models.FileField("Видео ответ", upload_to="media/videos/", blank=True)
